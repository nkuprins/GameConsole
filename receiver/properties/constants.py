...
# For the snake game
SNAKE_GAME_DELAY = 0.25
SNAKE_HEAD_COLOR = Color.BLUE
SNAKE_BODY_COLOR = Color.DARK_GREEN
SNAKE_FOOD_COLOR = Color.RED
SNAKE_BACKGROUND_COLOR = Color.BLACK
SNAKE_BORDER_COLOR = Color.YELLOW
...
PONG_BACKGROUND_COLOR = Color.BLACK
PONG_BORDER_COLOR = Color.WHITE
...
CUBES_GAME_SIZE = 4
CUBES_TIMEOUT = 7.0
CUBES_BACKGROUND_COLOR = Color.BLACK
